# https://byui-cse.github.io/cse110-course/lesson05/prove.html
...
if scenario == "MATCH": #DECISION MATCH
        ...
        if  scenario == "RUN": #DECISION MATCH -> RUN -> 
            ...
            while scenario != "ATTACK" and scenario != "CLIMB":
                scenario = input("Wrong answer! Do you ATTACK or CLIMB?: ").upper()
            ...
            if scenario == "WAIT": #DECISION MATCH -> HIDE -> WAIT
                print("You slept in the cavern. You see the dawn, it's time to go home... You survived!") #END 3

            elif scenario == "EXPLORE": #DECISION MATCH -> HIDE -> EXPLORE
                print("The bear wasn't that far. He caugth you. You died") #END 4
        ...
        while scenario != "LOOK" and scenario != "RUN":
            scenario = input("Wrong answer! Do you LOOK or RUN?: ").upper() 

        if scenario == "LOOK": #DECISION FLASHLIGHT -> LOOK
            scenario = input("You went to check that noise and found a dead rabbit near a trap, probably someone is hunting nearby. You hear a voice telling you 'Hey!'. Do you want to RUN or CHECK the voice?: ").upper()
            print()
            ...
            if scenario == "RUN": #DECISION FLASHLIGHT -> LOOK -> RUN
                print("You started running. It seems that someone was hunting indeed. You stepped on a bear trap. You died") #END 5

            elif scenario == "CHECK": #DECISION FLASHLIGHT -> LOOK -> CHECK
                print("It's Adam, one of your frinds! He is happy to find you and He takes you to his house nearby. You spent the night there. It's time to go home... You survived!") #END 6
           
            else: 
                print("Invalid decision, GAME OVER!")
    
        elif scenario == "RUN": #DECISION FLASHLIGHT -> RUN
            ...
            if scenario == "ENTER": #DECISION FLASHLIGHT -> RUN -> ENTER
                print("You see hunting tools and clothes, probalby someone is hunting nearby. You spent the night there. It's time to go home... You survived!") #END 7

            elif scenario == "EXPLORE": #DECISION FLASHLIGHT -> RUN -> EXPLORE
                print("You didn't find anything relevant. The night is dangerous and there are many wild animals. As you were walking you felt a bite on your ankle. It was a Cobra, it's too late for you. You died") #END 8
            else:
                print("Invalid decision, GAME OVER!")
        else: 
            print("Invalid decision, GAME OVER!")
